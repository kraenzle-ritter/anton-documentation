...
Admins und Superuser können direkt aus Anton heraus Feedback an die
Entwicklung schicken. Jede Rückmeldung landet
automatisch als Issue im GitHub-Repository von Anton, samt
technischem Kontext.

Das Formular läuft auf derselben Upload-Pipeline wie die übrigen
Anton-Eingabemasken (mit Drag-and-Drop / Cmd-V für
Screenshots).
...
- E-Mail-Adresse des absendenden Users
...
Die Upload-Constraints sind pro Tenant in der DB konfigurierbar, ohne
Code-Änderung:
