...
!!! info "Benutzereinstellungen"
    Alle Benutzer:innen können die gewichtete Suche in ihren persönlichen Einstellungen konfigurieren:
...
Wird "Standard" gewählt, wird die globale Einstellung verwendet.
